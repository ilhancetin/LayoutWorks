...
//        hide bottom shade pixel
    ...
    func setupViews() {
        ...
        NSLayoutConstraint.activate([containerView.topAnchor.constraint(equalToSystemSpacingBelow: view.safeAreaLayoutGuide.topAnchor, multiplier: 2), containerView.leadingAnchor.constraint(equalTo: view.leadingAnchor), containerView.trailingAnchor.constraint(equalTo: view.trailingAnchor), containerView.bottomAnchor.constraint(equalTo: view.safeAreaLayoutGuide.bottomAnchor)])
    ...
    @objc func musicTapped() {
        ...
        animeTransition(fromVC: viewControllers[1], toVC: viewControllers[0]) {success in
    ...
    @objc func podcastTapped() {
        ...
        animeTransition(fromVC: viewControllers[0], toVC: viewControllers[1]) {success in
    ...
    func animeTransition(fromVC: UIViewController, toVC: UIViewController, completion: @escaping ((Bool) -> Void)) {
        guard
